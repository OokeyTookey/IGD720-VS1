...
class WiggleStartAndEnded
{
    public int startIndex;
    public int endIndex;

    public WiggleStartAndEnded(int startIndex, int endIndex)
    {
...
public class CharacterWobbly : MonoBehaviour
{

    public TMP_Text[] dialogueStrings;
    public CharacterWobble characterWobble;

    TMP_Text textMesh;
    Mesh mesh;
    Vector3[] vertices;
    List<WiggleStartAndEnded> wiggleStartAndEnds = new List<WiggleStartAndEnded>();
    ...
    public void SetText(string newText)
    {
        ...
        for (int i = 0; i < text.Length; i++)
        {
            ...
            else if (text[i] == '@' && endIndex == -1)
            {
                endIndex = i;
                totalRemoval++;
                wiggleStartAndEnds.Add(new WiggleStartAndEnded(startIndex - totalRemoval, endIndex - totalRemoval));
                totalRemoval++;
                startIndex = -1;
                endIndex = -1;
            }
